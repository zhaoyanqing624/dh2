...
def cicle(x):
    while True:
        ...
        time.sleep(1)
        location = _Tools.getLocation.getPictureLocation("E:\\dh2\\bangpai\\"+x+".png", 0.9)
        if location != 0:
            break
def start(y):
    # 点击领取任务
        ...
        if location != 0:
            if x == "2_1":
                ...
                for x2 in y2:
                    time.sleep(1)
                    _Tools.getCutPicture.window_capture()
                    location_q = _Tools.getLocation.getPictureLocation("E:\\dh2\\bangpai\\" + x2 + ".PNG", 0.9)
                    if location_q != 0:
                        time.sleep(0.5)
...
def step_02():
    ...
    _Tools.getCutPicture.window_capture()
    time.sleep(1)
    location_0 = _Tools.getLocation.getPictureLocation("E:\\dh2\\bangpai\\0.png", 0.7)
    time.sleep(0.5)
...
def step_03(i):
    if i == 1:
        ...
        _Tools.getCutPicture.window_capture()
        time.sleep(1)
        location_1 = _Tools.getLocation.getPictureLocation("E:\\dh2\\bangpai\\1.png", 0.7)
        time.sleep(0.5)
...
def step_04():
    ...
    _Tools.getCutPicture.window_capture()
    time.sleep(1)
    location = _Tools.getLocation.getPictureLocation("E:\\dh2\\bangpai\\1_1.png", 0.8)
    if location == 0:
        time.sleep(1)
        pyautogui.click()
        time.sleep(1)
...
def step_05():
    ...
    for i in y:
        time.sleep(1)
        _Tools.getCutPicture.window_capture()
        location = _Tools.getLocation.getPictureLocation("E:\\dh2\\bangpai\\"+i+".PNG", 0.9)
        if location!=0:
            if i=="2_1":
                # 无名侠女
                print("无名侠女")
                ...
                while True:
                    ...
                    _Tools.getCutPicture.window_capture()
                    time.sleep(2)
                    location_11 = _Tools.getLocation.getPictureLocation("E:\\dh2\\bangpai\\2_3_1.png",0.4)
                    if location_11!=0:
                        click(164,329)
                        time.sleep(3)
                    else:
