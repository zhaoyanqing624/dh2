...
class TianTing():
    ...
    def task_start(self,i):
        Screen().cut_screen()
        time.sleep(1.5)
        lijing = Screen().get_location_picture('E:\\dh2\\game\\tianting\\0.png')
        if lijing is not 0:
        ...
        for j in list:
            ...
            while True:
                Screen().cut_screen()
                time.sleep(2)
                zidong = Screen().get_location_picture('E:\\dh2\\game\\tianting\\2.png')
        ...
        while True:
            Screen().cut_screen()
            time.sleep(2)
            lijing = Screen().get_location_picture('E:\\dh2\\game\\tianting\\0.png',0.9)
            if lijing is not 0:
                # Mouse().click_element(184, 396)
                break
